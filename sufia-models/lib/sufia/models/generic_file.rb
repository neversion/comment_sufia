module Sufia
  module GenericFile
    ...
    #自定义字段
    attr_accessor :subtitle, :keyword, :set_number, :call_number, :class1, :class2,
                  :format_number, :media_format, :url, :becount, :publishe_date,
                  :app_format, :cover_pic, :the_time, :data_stamp
